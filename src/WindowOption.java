...
public class WindowOption extends javax.swing.JFrame {
    ...
    private void writeToPropertyFile(String path) {
        ...
        try {
            ...
            String midiPath = prop.getProperty("midiPath");
            // set the properties value
            prop.setProperty("midiPath", midiPath);
            prop.setProperty("extraction", "" + extractHitSounds);
            prop.setProperty("keyCount", "" + keySet);
            prop.setProperty("OD", "" + overallDifficulty);
            prop.setProperty("maxChord", "" + maxChord);
            prop.setProperty("coop", "" + coop);
            prop.setProperty("mergeHS", "" + mergeHS);
