...
public class Utils {
     ...
     * @param bpms array of bpm
     * @param time in tick, current time
     ...
     *
     * @param currentTime in tick or ms
     * @param timeline in tick or ms
     ...
     *
     * @param filePath output location
